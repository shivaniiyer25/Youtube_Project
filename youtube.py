...
import pymongo
client = pymongo.MongoClient("mongodb+srv://iyershivani2001:OGNtUrmaaGhns0o@cluster0.uhmkf4f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
with st.sidebar:
    ...
    youtube_logo_image = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/YouTube_icon_%282013-2017%29.png/480px-YouTube_icon_%282013-2017%29.png"
    st.image(youtube_logo_image, caption='YouTube Logo')
    ...
    if st.button("Collect and Store Data"):
        ...
        if channel_id in ch_ids:
            st.success("Channel Details of the given channel already exist")
        else:
...
channel_id_for_image =  ["UC27ndgSDz1uqVhTG9n_ytDA",#syed
...
image_url = get_channel_image(channel_id_for_image)
selected_channel_id = st.selectbox("Select a channel ID", channel_id_for_image)
st.image(image_url, use_column_width= 150)




show_tables = st.selectbox("SELECT THE TABLE FOR VIEWING",("CHANNELS","PLAYLISTS","VIDEOS","COMMENTS"))
